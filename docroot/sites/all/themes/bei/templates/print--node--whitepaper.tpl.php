...
if ($format == 'pdf') {
  $url = $base . '/printpdf/' . $node->nid;
}
else {
  $url = $base . '/print/' . $node->nid;
}

$styles_path = $base . '/' . drupal_get_path('theme',$GLOBALS['theme']) . '/css/print.css';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  <head>
    ...
    <meta name="subject" content="<?php print $node->title; ?>"/>
    <link href="<?php print $styles_path; ?>" rel="stylesheet">
  </head>
  <body class="whitepaper <?php print $format; ?>">
