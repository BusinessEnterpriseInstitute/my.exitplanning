...
class Utilities {
    ...
    public static function AddSupportButton(&$form, &$form_state)
    {
        ...
        $form['markup_support_1'] = array(
            '#markup' => '<h3><b>Feature Request/Contact Us:</b></h3><div>Need any help? We can help you with configuring your OAuth Provider. Just send us a query and we will get back to you soon.<br /></div>',
        );
            ...
            '#markup' => '<div class="table-responsive mo_guide_text-center" style="font-family: sans-serif;font-size: 15px;">          
                <table class="mo_guide_table mo_guide_table-striped mo_guide_table-bordered" style="border: 1px solid #ddd;max-width: 100%;border-collapse: collapse;">
                    ...
                    <tbody style="color:gray;">
                        <tr><td class="mo_guide_text-center" >AWS Cognito</td><td><strong><a href="https://plugins.miniorange.com/configure-aws-cognito-oauthopenid-connect-server-drupal" class="mo_guide_text-color" target="_blank">Click Here</a></strong></td></tr>
